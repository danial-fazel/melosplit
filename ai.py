...
class AIService:
    ...
    def send_request(self, prompt, max_length=200):
        """
        ...
        """
        data = {"inputs": prompt, "parameters": {"max_length": max_length}}
    ...
    def create_prompt(group_name, group_description, members, transactions, genre):
        """
        Create a tailored prompt for the AI.
        :param group_name: Name of the group.
        :param group_description: Description of the group.
        :param members: Dictionary of group members.
        :param transactions: List of transactions in the group.
        :param genre: The desired story genre.
        :return: The formatted prompt string.
        """
        genre_instructions = {
            "scary": "Make it a suspenseful and thrilling story.",
            "funny": "Add humor and make it a fun, lighthearted story.",
            "mysterious": "Add mystery and intrigue to the story.",
            "mixed": "Combine humor, mystery, and suspense.",
            "random": "Feel free to add any creative elements you like.",
        }
        ...
        return (
            f"You are a storytelling AI. Create a story based on the following group details:\n\n"
            f"Group Name: {group_name}\n"
            f"Group Description: {group_description}\n"
            f"Members: {member_names}\n"
            f"Transactions:\n{transaction_details}\n\n"
            f"{genre_instruction} Make it engaging and memorable.PLEASE DO NOT REPEAT THIS WORDS AND BEGAN WITH TELLING ME THE STORY."
        )
